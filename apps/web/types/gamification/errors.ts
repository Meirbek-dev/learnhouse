...
export function createNetworkError(message: string, statusCode?: number, retryable = true): NetworkError {
  return {
...
export function createAuthError(message: string, requiresReauth = true): AuthError {
  return {
...
export function createDailyLimitExceededError(
  message: string,
  currentXP: number,
  dailyLimit: number,
  resetTime: string,
  ...
  return {
    type: ERROR_TYPES.DAILY_LIMIT_EXCEEDED,
    message,
    timestamp: new Date().toISOString(),
    currentXP,
    dailyLimit,
...
export function createServerError(message: string, statusCode: number, errorCode?: string): ServerError {
  return {
...
export function createUnknownError(message: string, originalError?: unknown): UnknownError {
  return {
