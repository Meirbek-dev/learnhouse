...
const transformDiscussionToPost = (discussion: any) => {
  ...
  return {
    ...
    upvotes: Number.parseInt(discussion.likes_count) || 0,
    downvotes: Number.parseInt(discussion.dislikes_count) || 0,
    ...
    replies:
      discussion.replies?.map((reply: any) => ({
        ...
        upvotes: Number.parseInt(reply.likes_count) || 0,
        downvotes: Number.parseInt(reply.dislikes_count) || 0,
    ...
    try {
      const newReply = await createDiscussion(
        courseUuid,
        {
          ...
          type: 'reply',
          parent_discussion_id: Number.parseInt(parentPost.id),
          org_id: org.id,
        },
        access_token,
      );
      ...
      const transformedReply = {
        ...
        upvotes: Number.parseInt(newReply.likes_count.toString()) || 0,
        downvotes: 0,
        userVote: null,
      };
