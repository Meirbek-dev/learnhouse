          ...
          <Card>
            ...
            <CardContent className="space-y-8">
              ...
              <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
                <div className="group relative overflow-hidden rounded-xl border border-border bg-gradient-to-br from-blue-50 to-blue-100/50 p-5 transition-all duration-200 hover:shadow-lg hover:shadow-blue-100">
                  <div className="flex items-start gap-4">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="mt-1 text-3xl font-bold text-foreground">{questionCount}</p>
                    </div>
                  </div>
                  <div className="absolute right-0 bottom-0 h-20 w-20 translate-x-8 translate-y-8 rounded-full bg-blue-600/10" />
                </div>

                <div className="group relative overflow-hidden rounded-xl border border-border bg-gradient-to-br from-orange-50 to-orange-100/50 p-5 transition-all duration-200 hover:shadow-lg hover:shadow-orange-100">
                  <div className="flex items-start gap-4">
                ...
                {attemptLimit && attemptLimit > 0 && !isTeacher && (
                  <div className="group relative overflow-hidden rounded-xl border border-border bg-gradient-to-br from-purple-50 to-purple-100/50 p-5 transition-all duration-200 hover:shadow-lg hover:shadow-purple-100">
                    <div className="flex items-start gap-4">
              ...
              <div className="space-y-5 rounded-xl bg-gradient-to-br from-gray-50 to-gray-100/50 p-6">
                <div className="flex items-center gap-2">
                  ...
                  <h3 className="text-lg font-bold text-foreground">{t('instructions')}</h3>
                </div>
                <ul className="space-y-3">
                  <li className="flex items-start gap-3 rounded-lg bg-card p-3 shadow-sm">
                    <div className="flex h-6 w-6 flex-shrink-0 items-center justify-center rounded-full bg-green-100">
                      <CheckCircle className="h-4 w-4 text-green-600" />
                    </div>
                    <span className="flex-1 text-sm leading-relaxed text-foreground">{t('instruction1')}</span>
                  </li>
                  {timeLimit && (
                    <li className="flex items-start gap-3 rounded-lg bg-card p-3 shadow-sm">
                      <div className="flex h-6 w-6 flex-shrink-0 items-center justify-center rounded-full bg-green-100">
                  ...
                  <li className="flex items-start gap-3 rounded-lg bg-card p-3 shadow-sm">
                    ...
                    <span className="flex-1 text-sm leading-relaxed text-foreground">{t('instruction2')}</span>
                  </li>
                  {settings.tab_switch_detection && (
                    <li className="flex items-start gap-3 rounded-lg bg-card p-3 shadow-sm">
                      ...
                      <span className="flex-1 text-sm leading-relaxed text-foreground">{t('instruction4')}</span>
                    </li>
                  )}
                  {settings.copy_paste_protection && (
                    <li className="flex items-start gap-3 rounded-lg bg-card p-3 shadow-sm">
                      ...
                      <span className="flex-1 text-sm leading-relaxed text-foreground">{t('instruction5')}</span>
                    </li>
                  )}
                </ul>
              </div>
