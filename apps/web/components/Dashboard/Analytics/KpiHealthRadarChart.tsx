      ...
      <CardContent>
        ...
        >
          <RadarChart data={data} cx="50%" cy="50%">
            ...
            <Radar dataKey="previous" stroke="var(--color-previous)" fill="var(--color-previous)" fillOpacity={0.12} strokeWidth={1.5} strokeDasharray="4 2" />
            <Radar dataKey="current" stroke="var(--color-current)" fill="var(--color-current)" fillOpacity={0.22} strokeWidth={2} />
          </RadarChart>
        </ChartContainer>
      </CardContent>
    </Card>
