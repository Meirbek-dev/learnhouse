  ...
  const handlePreviewUpload = async (
    ...
    if (event.target.files && event.target.files.length > 0) {
      ...
      const loadingToast = toast.loading(
        tNotify('uploadingPreviews', { count: files.length })
      )
      ...
      try {
        ...
        toast.success(
          tNotify('previewsAddedSuccess', { count: files.length }),
          { id: loadingToast }
        )
        router.refresh()
      } catch (err) {
              ...
              <div className="flex flex-col justify-center items-center space-y-8">
                ...
                <div className="flex flex-col items-center space-y-4">
                  ...
                  <div className="flex flex-col text-xs space-y-2 items-center text-gray-500">
                    ...
                    <p className="text-gray-400">
                      {t('Info.recommendedSizeThumbnail')}
                    </p>
                  </div>
                </div>
              </div>
                                        ...
                                        <div className="flex items-center space-x-3">
                                          ...
                                          <div>
                                            <h3 className="font-medium text-gray-900">
                                              {selectedService === 'youtube'
                                                ? t(
                                                    'Dialog.AddVideo.youtubeTitle'
                                                  )
                                                : t(
                                                    'Dialog.AddVideo.loomTitle'
                                                  )}
                                            </h3>
                                            <p className="text-sm text-gray-500">
                                              {selectedService === 'youtube'
                                                ? t(
                                                    'Dialog.AddVideo.youtubeDescription'
                                                  )
                                                : t(
                                                    'Dialog.AddVideo.loomDescription'
                                                  )}
                                            </p>
                                          </div>
                                        </div>
                                      ...
                                      <div className="space-y-3">
                                        <Input
                                          ...
                                          placeholder={
                                            selectedService === 'youtube'
                                              ? t(
                                                  'Dialog.AddVideo.youtubePlaceholder'
                                                )
                                              : t(
                                                  'Dialog.AddVideo.loomPlaceholder'
                                                )
                                          }
                                          value={videoUrl}
                                          onChange={(e) =>
