...
/**
 * SIMPLIFIED GAMIFICATION SETTINGS
 *
 * Only 3 core toggles:
...
const DEFAULT_PREFERENCES: SimplifiedPreferences = {
  showOnLeaderboard: true,
  xpGainNotifications: true,
  animatedEffects: true,
};

export default function UserGamificationSettingsSimplified() {
  ...
  const [preferences, setPreferences] = useState<SimplifiedPreferences>(DEFAULT_PREFERENCES);
  ...
  const handlePreferenceChange = (key: keyof SimplifiedPreferences, value: boolean) => {
