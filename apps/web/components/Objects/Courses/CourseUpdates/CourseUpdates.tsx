...
const UpdatesSection = () => {
  ...
  return (
    <div className="bg-white/95 backdrop-blur-md nice-shadow rounded-lg w-[700px] overflow-hidden">
      <div className="bg-gray-50/70 flex justify-between outline-1 rounded-lg outline-neutral-200/40">
        ...
        {adminStatus.isAdmin && (
          <div
            ...
            className="py-2 px-4 space-x-2 items-center flex cursor-pointer text-xs font-medium hover:bg-gray-200 bg-gray-100 outline-1  outline-neutral-200/40"
          >
            <PencilLine size={14} />
