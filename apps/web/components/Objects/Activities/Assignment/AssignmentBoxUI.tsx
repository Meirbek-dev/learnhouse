    ...
    <div className="flex flex-col px-3 sm:px-6 py-4 nice-shadow rounded-md bg-slate-100/30">
      <div className="flex flex-col sm:flex-row sm:justify-between sm:space-x-2 pb-2 text-slate-400 sm:items-center">
        ...
        <div className="flex flex-wrap gap-2 items-center mb-2 sm:mb-0">
          ...
          {view === 'teacher' && (
            <div className="flex bg-amber-200/20 text-xs rounded-full space-x-1 px-2 py-0.5 font-bold items-center text-amber-600 outline-amber-300/40">
              <BookUser size={12} />
              <p>{t('teacherView')}</p>
            </div>
          )}
          {maxPoints && (
            <div className="flex bg-emerald-200/20 text-xs rounded-full space-x-1 px-2 py-0.5 font-bold items-center text-emerald-600 outline-emerald-300/40">
              <BookPlus size={12} />
