  ...
  const [discussionPosts, setDiscussionPosts] = useState<any[]>([
    {
      ...
      lastName: '',
      postMessage: '<p><strong>Отличный курс!</strong> Я так многому научился благодаря видеоматериалам и практическим примерам.</p><p>Особенно понравились:</p><ul><li>Интерактивные упражнения</li><li>Подробные объяснения</li><li>Практические примеры</li></ul><p>Рекомендую всем! 👍</p>',
      ...
      replies: [
        {
          ...
          lastName: 'Преподович',
          replyMessage: '<p>Спасибо за <em>положительный отзыв</em>! Рад, что контент оказался вам полезен.</p><p>Если у вас есть вопросы, не стесняйтесь задавать их в комментариях.</p>',
    ...
    },
    {
      ...
      firstName: 'Меирбек Канатович',
      lastName: '',
      postMessage: '<p>Задания сложные, но действительно помогают закрепить знания.</p><blockquote><p>Практика — лучший учитель!</p></blockquote><p>Особенно понравилось <code>практическое задание №3</code> — очень познавательно.</p>',
    ...
    },
    {
      ...
      firstName: 'Махмет',
      lastName: 'Махметов',
      postMessage: '<p>У кого-нибудь ещё были проблемы с <strong>третьим заданием</strong>? Я застрял на этапе реализации.</p><p>Вот код, с которым работаю:</p><pre><code>function calculateResult() {\n  // Здесь моя логика\n  return result;\n}</code></pre><p>Буду благодарен за помощь! 🙏</p>',
      ...
      replies: [
        {
          ...
          firstName: 'Махмуд',
          lastName: 'Махмудов',
          replyMessage: '<p>У меня была та же проблема! Попробуйте посмотреть <a href="#chapter2">документацию в главе 2</a> — это помогло мне разобраться.</p><p>Также рекомендую посмотреть это видео:</p><p><a href="https://www.youtube.com/watch?v=dQw4w9WgXcQ">Полезное объяснение</a></p>',
