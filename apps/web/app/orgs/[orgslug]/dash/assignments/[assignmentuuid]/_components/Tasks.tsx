            ...
            return (
              ...
              >
                <div className="flex items-center px-2 justify-between">
                  ...
                  <button
                    className={`outline-gray-200 ${task.assignment_task_uuid == assignmentTask.selectedAssignmentTaskUUID ? 'bg-slate-100' : ''} hover:bg-slate-100/50 rounded-md text-gray-500 font-bold py-2 px-3  ease-linear transition-all`}
                  >
