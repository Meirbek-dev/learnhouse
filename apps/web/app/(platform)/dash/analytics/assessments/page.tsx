  ...
  try {
    ...
    return (
      <div className="mx-auto flex w-full max-w-[1440px] flex-col gap-6 px-4 py-6 md:px-6 xl:px-8">
        <TeacherFilterBar path="/dash/analytics/assessments" query={query} courseCount={assessments.course_options.length} courseOptions={assessments.course_options} cohortOptions={assessments.cohort_options} orgslug={PLATFORM_ORG_SLUG} />
        ...
        <AssessmentOutliersTable orgslug={PLATFORM_ORG_SLUG} rows={assessments.items} storageKey="assessments-page" serverPaginated />
        {totalPages > 1 ? (
