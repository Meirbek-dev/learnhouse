...
export async function linkResourcesToUserGroup(usergroup_id: any, resource_uuids: any, access_token: string) {
  const result: any = await fetch(
...
export async function unLinkResourcesToUserGroup(usergroup_id: any, resource_uuids: any, access_token: string) {
  const result: any = await fetch(
