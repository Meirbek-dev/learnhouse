...
const runtimeCases = [
  ...
  { title: 'warning callout', run: (editor: Editor) => editor.commands.insertWarningCallout(), expectedType: 'calloutWarning' },
  ...
  { title: 'math equation', run: (editor: Editor) => editor.commands.insertMathEquation(), expectedType: 'blockMathEquation' },
  ...
  { title: 'web preview', run: (editor: Editor) => editor.commands.insertWebPreview(), expectedType: 'blockWebPreview' },
];
