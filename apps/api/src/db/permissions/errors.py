...
def raise_permission_denied(
    ...
    """
    Raise a standardized permission denied error.

    Args:
        action: The action being attempted (e.g., "update")
        resource_type: Type of resource (e.g., "course")
        resource_id: Optional resource ID
        message: Optional custom message
    """
    if not message:
        message = f"You don't have permission to {action} this {resource_type}"

    required_perm = f"{resource_type}:{action}:own"
...
def raise_authentication_required(
    ...
    """
    Raise a standardized authentication required error.
...
def raise_resource_not_found(
    ...
    """
    Raise a standardized resource not found error.
