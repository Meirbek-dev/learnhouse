...
class TestQuizGrading:
    ...
    def test_single_correct_answer_correct_submission(self):
    ...
    def test_single_correct_answer_wrong_submission(self):
    ...
    def test_multiple_correct_answers_all_selected(self):
    ...
    def test_multiple_correct_answers_partial_selection(self):
    ...
    def test_mixed_correct_and_wrong_answers(self):
    ...
    def test_custom_answer_requires_manual_grading(self):
