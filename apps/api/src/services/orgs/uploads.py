...
async def upload_org_logo(logo_file: UploadFile) -> str:
...
async def upload_org_thumbnail(thumbnail_file: UploadFile) -> str:
...
async def upload_org_preview(file: UploadFile) -> str:
...
async def upload_org_landing_content(file: UploadFile) -> str:
