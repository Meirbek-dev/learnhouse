...
down_revision: Union[str, None] = '9daecf9a5854'
...
def upgrade() -> None:
    ...
    op.create_index('ix_role_audit_log_org_timestamp', 'role_audit_log', ['org_id', 'timestamp'])
    op.create_index('ix_role_audit_log_target_role_id', 'role_audit_log', ['target_role_id'])
