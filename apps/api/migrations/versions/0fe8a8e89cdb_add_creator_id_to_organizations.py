...
def upgrade() -> None:
    """Upgrade schema."""
    op.add_column('organization', sa.Column('creator_id', sa.BigInteger(), nullable=True))
...
def downgrade() -> None:
    """Downgrade schema."""
    op.drop_constraint('fk_organization_creator_id_user', 'organization', type_='foreignkey')
