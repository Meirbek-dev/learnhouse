...
ARG NEXT_PUBLIC_PLATFORM_TOP_DOMAIN
ARG NEXT_PUBLIC_PLATFORM_HTTPS
ARG NEXT_PUBLIC_PLATFORM_MEDIA_URL

ENV NEXT_PUBLIC_PLATFORM_API_URL=$NEXT_PUBLIC_PLATFORM_API_URL
ENV NEXT_PUBLIC_PLATFORM_BACKEND_URL=$NEXT_PUBLIC_PLATFORM_BACKEND_URL
ENV NEXT_PUBLIC_PLATFORM_DOMAIN=$NEXT_PUBLIC_PLATFORM_DOMAIN
ENV NEXT_PUBLIC_PLATFORM_TOP_DOMAIN=$NEXT_PUBLIC_PLATFORM_TOP_DOMAIN
ENV NEXT_PUBLIC_PLATFORM_HTTPS=$NEXT_PUBLIC_PLATFORM_HTTPS
ENV NEXT_PUBLIC_PLATFORM_MEDIA_URL=$NEXT_PUBLIC_PLATFORM_MEDIA_URL
